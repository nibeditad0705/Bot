...
class BookingInformation():
    ...
    def get_status_info(self,name,int1,int2):
        ...
        dd = pd.read_csv(r"C:/Users/nibedita.dutta/Desktop/Learning/EY Bot/Names.csv")
    ...
    def get_inclusion(self,name,date,sttime,entime):
        ...
        if len(k)==len(name):
                ...
                def send_appointment(date, attendee_email, organiser_email, subj, description, location, start_hour, start_minute,end_hour,end_minute):
                                  ...
                                  mailServer.starttls()
                                  mailServer.ehlo()
                                  mailServer.login('nickjonas5901@gmail.com', 'Whatwomenwant5901!')
                                  mailServer.ehlo()
                ...
                for it in app:
                   send_appointment(date, it , 'nickjonas5901@gmail.com', 'Invitation', 'Invitation','', sth, stm,eth,etm)
                ...
                #participant=list(set(participant))
                   ...
                   send_appointment1(date, it , 'nickjonas5901@gmail.com', 'Invitation', 'Invitation', '', sth, stm,eth,etm)
    ...
    def reschedule_meet(self,name,date,sttime,entime):
        ...
        for it in name:
            if it in dd['First Name'].values.tolist():
                ...
                send_appointment(origdate, mail[0] , 'nickjonas5901@gmail.com', 'Invitation', 'Invitation', '', sth, stm,eth,etm)
                ...
                send_appointment1(chandate, mail[0] , 'nickjonas5901@gmail.com', 'Invitation', 'Invitation', '', sth, stm,eth,etm)
        ...
        for it in name:
            if it in dd['First Name'].values.tolist():
                ...
                if 'Busy' in k1:       
                    ...
                    send_appointment(date, mail[0] , 'nickjonas5901@gmail.com', subj, desc, loc, sth, stm,eth,etm)
